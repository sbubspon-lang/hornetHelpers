...
def is_valid_email(email):
    valid_email_pattern = (
        r"^[a-zA-Z0-9._%+-]+@[a-zA-Z0-9.-]+\.(com|net|org|edu|gov|me)$"
    )
...
def new_account():
    ...
    if request.method == "POST":
        ...
        if (
            user_repo.find_user(username)
            or user_repo.find_by_email(email)
        ):
        ...
        if account_type == "Admin":
            ...
            if not career_center_role:
                flash(
                    "Career center role is required "
...
def forgot_password():
    ...
    if request.method == "POST":
        ...
        flash(
            ...
            "you should receive a password reset link!"
        )
    ...
    if request.method == "POST":
        ...
        if not is_valid_password(new_password):
            ...
            flash(
                ...
                "long and contain at least 1 letter and number."
            )
